...
<?php error_reporting(0); ?>
    ...
    <meta name="description" content="Produk By Cloud Dark">
    <meta name="author" content="Cloud Dark">
            ...
            <table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $id;?></td>
                        <td><?php echo $nm;?></td>
                        <td> <img src="http://barcodes4.me/barcode/c39/<?php echo $id; ?>.png?IsBorderDrawn=1&IsTextDrawn=1&width=50&height=75" alt=""> </td>
